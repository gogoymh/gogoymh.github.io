...
## 요약
* <span class="highlight-red">이 논문은 Long Range Arena(LRA)라는 이름의 Benchmark Dataset에 대해 설명하는 논문으로,
...
* 각 태스크의 시퀀스는 1K에서 16K까지 있으며, text, natural, synthetic images, and mathematical expressions 등 여러 modality의 데이터로 구성되었다.
...
6. Non-resource intensive and accessible
