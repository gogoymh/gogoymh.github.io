...
4. > ![jekyll-sample(4)](/../public/images/post.2019-06-30/jekyll-sample(4).PNG)그 후 다시 콘솔창에 가서 <strong class ="highlight-yellow">jekyll serve</strong>를 입력하게 되면, <strong class ="highlight-blue">http://127.0.0.1:4000/</strong>의 주소를 주게 되는데, 이것은 내 컴퓨터 Local에서 Jekyll의 사이트를 확인할 수 있다. Jekyll파일에 수정사항이 생겼을 때는 *F5*로 새로고침을 해서 수정사항을 확인할 수 있다.

5. > ![jekyll-sample(5)](/../public/images/post.2019-06-30/jekyll-sample(5).PNG)다음과 같은 예제 사이트를 만든 것을 확인할 수 있다. 

# 사이트의 제목을 바꾸어보자!
Jekyll의 사이트에 대한 정보는 대부분 **_config.yml**안에 있다. ![jekyll-sample(6)](/../public/images/post.2019-06-30/jekyll-sample(6).PNG)에서 <strong class ="highlight-blue">title: Your awesome title</strong>의 값을 수정해보자
> ![jekyll-sample(7)](/../public/images/post.2019-06-30/jekyll-sample(7).PNG) 다음과 같이 title이 *Hello new world*로 바뀐것을 볼 수 있다. 
