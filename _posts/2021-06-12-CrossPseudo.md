...
* Semi supervised learning을 위해 두 모델을 이용하거나 Stop gradient(//)을 이용한 비슷한 연구와 비교하였다.\\
> [![compare](/../public/images/posts/Cross-compare.PNG)](/../public/images/posts/Cross-compare.PNG)
  ...
  하이퍼파라미터도 추가되는 것 없이 다른 semi-supervised setup에서도 사용되는 loss 사이의 가중치만 있기 때문에 많은 데이터셋에 안정적으로 적용하기 쉽다.
