...
> [![compare](/../public/images/posts/Cross-compare.PNG)](/../public/images/posts/Cross-compare.PNG)
  ...
  regularization으로 인한 퍼포먼스 향상이 꽤 보장된다.(궁금하다면 Stochastic Weight Averaging에 대해 검색해보길 추천한다.)\\
  그런데 이런 average 방식 없이 훨씬 간단하게 두 모델의 아웃풋을 cross하여 label로  SGD 하는 것이 더 나은 결과를 만들었다는 점이 인상적이었다.
