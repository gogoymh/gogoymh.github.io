...
* 2D Fourier transform을 attention 대신 적용하며, 1D Fourier Transform을 sequence dimension과 hidden dimension에 두 번 연속으로 적용하는 방식을 채택한다.
* 두 번 fourier transform을 수행하고, real part만 output으로 사용한다.\\
