...
![Mygithub](/public/images/MyGithub.PNG)
위는 나의 Github Page이다. [나의 Github Page](http://github.com/Changemin)

- - -
### Git bash 설치하기 
Git bash는 git을 사용하기 위한 툴이다.

1. > ![install-git(1)](/public/images/install-git(1).PNG)
우선 Git Bash 설치파일을 받기 위해 공식 홈페이지인 [https://git-scm.com/](https://git-scm.com/) 으로 가서 오른쪽 중간에 있는 *Download 2.22.0 for Windows*를 누른다. 

2. > ![install-git(2)](/public/images/install-git(2).PNG)
자동으로 설치파일이 설치된다. 자동으로 설치가 안될경우 버튼을 눌러 수동으로 설치한다.
3. > ![install-git(3)](/public/images/install-git(3).PNG)
설치된 .exe파일을 실행하고 Next
4. > ![install-git(4)](/public/images/install-git(4).PNG)
다음과 같은 기본 설정에서 Next
5. > ![install-git(6)](/public/images/install-git(6).PNG)
이것도 기본 설정 Next
6. > ![install-git(7)](/public/images/install-git(7).PNG)
User the OpenSSL library -> Next
7. > ![install-git(8)](/public/images/install-git(8).PNG)
기본 설정 Next
8. > ![install-git(9)](/public/images/install-git(9).PNG)
Use MinTTY -> Next
9. > ![install-git(10)](/public/images/install-git(10).PNG)
Enable file system caching, Enable Git Credential Manager chech -> Next
10. > ![install-git(11)](/public/images/install-git(11).PNG)
새로운 기능들을 선택해서 적용할 수 있다. 나는 아무것도 선택하지 않았다!
11. > ![install-git(12)](/public/images/install-git(12).PNG)
준비가 모두되었다. 이제 install 을 눌러 설치하면 된다!
12. > ![install-git(13)](/public/images/install-git(13).PNG)
